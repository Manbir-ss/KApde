        ...
        <>
            <section>
                <section className="scroll-section-outer" id="width" style={{ width: "50%", float: 'left' }}>
                    <div  ref={signalRef} style={{ alignItems:"center", width: "50%", float: 'left' }}>
                        <div className="htina"><img  src={img4} style={{ height: "400px", width: "300px", marginTop: "110px", position: "absolute", marginLeft: "-90px" }} /></div>
