    ...
    return(
        ...
        <div style={{display:"flex"}}>
                ...
                <div style={{marginLeft:"50px",marginTop:"170px"}}>
                    ...
                    <br />
                    <input type="password" placeholder="Confirm Password" id="fname" name="fname" />
                    <br />
                    <div className="subs">
                    <Button style={{ marginBottom:"40px", marginTop: "20px" }} type="submit">Register</Button>
                    </div>
                    <p style={{textAlign:"left"}}>Or Register With :</p>
                    <div style={{display:"flex"}}>
